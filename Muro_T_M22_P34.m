...
b_1=394; %Ancho del ala
b_2=10; %Ancho del alma
h_1=12; %Altura del ala
h_2=412; %Altura total - Altura del alma h_2-h_1
Ag=b_1*h_1+b_2*(h_2-h_1); %cm2

%% Input - Distribución de aceros

n=26; %Número de capas de acero

%De arriba hacia abajo

As=[10.5; repmat(0.5,18,1); repmat(1.13,7,1)]; %Área de aceros - cm2

eid=[6; 9; repmat(20,17,1); 6; repmat(8,7,1)]; %Distancia entre barras - cm
...
c=0.00001:n_c:h_2+0*h_2; %Se puede cambiar según los puntos que se desea observar
%h_2+0.178*h_2
e_i_a=[];
...
while flag==0 || flag==1
    ...
    for i=1:length(c)
        ...
        if a(i)<h_1
            ...
            M_real(i)=(P_con_ala*(y_c_1-h_1/2)+P_con_alma*(y_c_1-(a(i)-h_1)/2)...
                -sum(ms_i))/100000;
...
load('T_P34_M22.txt')
P_u_M22=T_P34_M22(:,1); %ton
M_u_M22=T_P34_M22(:,2); %ton.m
...
print('C_I_Conven_T_P34_M22','-djpeg','-r300')
